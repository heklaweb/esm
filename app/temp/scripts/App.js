...
(0, _jquery2.default)(document).ready(function () {
    ...
    function calcRemainingHeight() {
        ...
        remainingHeight = (0, _jquery2.default)(window).height() - (0, _jquery2.default)(".site-header").outerHeight() - (0, _jquery2.default)(".site-footer").outerHeight();
        // console.log("Verbleibende Höhe für Content: " + remainingHeight);
    }

    function setContentHeight() {
        calcRemainingHeight();
        (0, _jquery2.default)(".site-content").height(remainingHeight);
    }
